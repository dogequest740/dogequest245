...
const WORLD_BOSS_PRIZE_POOL = 2000;
const WORLD_BOSS_DAMAGE_PER_SEC_CAP = 5000;
const WORLD_BOSS_TICKET_COST_GOLD = 25000;
...
const REFERRAL_CONTEST_PRIZE_FIRST = 5000;
const REFERRAL_CONTEST_PRIZE_SECOND = 3000;
const REFERRAL_CONTEST_PRIZE_THIRD = 2000;
const REFERRAL_CONTEST_PRIZE_FOURTH = 1000;
const REFERRAL_CONTEST_PRIZE_FIFTH = 500;
...
const buildReferralContestSnapshot = async (
  ...
  const contest: ReferralContestInfoRow = {
    ...
    prizes: {
      ...
      fourth: REFERRAL_CONTEST_PRIZE_FOURTH,
      fifth: REFERRAL_CONTEST_PRIZE_FIFTH,
    },
  };
